package dao; // coloca la clase compilada en tpvlibre/conexiones
...
public class ManejadorBaseDatos {
    ...
    private String password = "1234"; // contrase�a del usuario que se puede conectar
    ...
    private String basedatos = "jdbc:mysql://localhost/bd_pqrs"; 
    private static ManejadorBaseDatos instancia; // patron de dise�o singleton
    private Logger log = Logger.getLogger(dao.ManejadorBaseDatos.
                                          class.getName());
